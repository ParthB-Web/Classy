  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-12">
        <Link href="/">
          <a 
            className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary active:text-primary transition-colors duration-300 font-sans mb-6 md:mb-8 touch-manipulation"
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-12">
          ...
          <article className="lg:col-span-9 max-w-3xl">
            <header className="mb-16 md:mb-24">
              ...
              <h1 
                className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light tracking-tight mb-6 md:mb-8 leading-tight"
                style={{ fontFamily: 'var(--font-serif)' }}
                data-testid="heading-manifesto-title"
              >
                The Closed Architecture
              </h1>
              <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground leading-relaxed max-w-2xl" style={{ fontFamily: 'var(--font-serif)' }}>
                A manifesto on causation, consciousness, and the structure beneath.
              </p>
            </header>

            <div className="prose-custom">
              <p className="text-base md:text-lg leading-[1.85] mb-6" style={{ fontFamily: 'var(--font-serif)' }}>
              ...
              <ManifestoSection id="world" title="I. THE WORLD AS RELAXATION">
                <p className="text-base md:text-lg leading-[1.85]" style={{ fontFamily: 'var(--font-serif)' }}>
